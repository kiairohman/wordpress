...
$wtr_Color_25 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '#bbpress-forums #bbp-search-form .hidden:before, .wtrSearchInputButton:before, .wtrSearchInputButton, .wtr404ButtonColors',
		'css_style' 	=> 'color',
		)
);
...
$wtr_Color_30 = new WTR_Customize_Setting ( array(
		'id' 			=> 'wtr_Color_30',
		'default'		=> '#ffffff',
		'control_args'	=> array( 'label' 	=> __( 'Conatiner background color for elements like tables, forum, tabs and others', 'wtr_framework' ) ),
		'control_type'	=> 'color',
...
$wtr_Color_31 = new WTR_Customize_Setting ( array(
		'id' 			=> 'wtr_Color_31',
		'default'		=> '#ffffff',
		'control_args'	=> array( 'label' 	=> __( 'Background color for conatiner elements like tabs and tables', 'wtr_framework' ) ),
		'control_type'	=> 'color',
...
$wtr_Color_39 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '#bbpress-forums #bbp-single-user-details #bbp-user-navigation li.current a, #bbpress-forums li.bbp-footer, .select2-results .select2-highlighted, .wtrShtFullWidthTabs .wtrShtFWT, .wtrShtLinkHedline, .wtrShtTimeTableItem thead, .wtrShtPassDesc, .wtrShtLastNewsMetro .wtrShtLastNewsBoxedItemHolder, .wtrShtEventListTime',
		'css_style' 	=> 'background-color',
		)
);
...
$wtr_Color_46 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '.woocommerce a.button.alt.wc-forward.checkout-button, .bbp-submit-wrapper .user-submit, button#bbp_forum_submit, .bbp-submit-wrapper button#bbp_reply_submit, .bbp-submit-wrapper button#bbp_topic_submit, .bbp-submit-wrapper button#bbp_reply_submit, .bbp-submit-wrapper button#bbp_topic_submit, .bbp-submit-wrapper button#bbp_topic_submit, .bbp-submit-wrapper button#bbp_reply_submit, .wtrShtPayPal.light .wtrShtPPPriceBtn, .wtrPayPal .wtrPayPalBtnAct:hover, .wtrPLPayPalBtnAct:hover, .wtrEPPayPalBtnAct:hover, .wtrCPPayPalBtnAct, .wtrShtLastNewsStandard a.wtrButtonStd.green, .woocommerce .wtrContainer  #content input.button.alt, .woocommerce .wtrContainer  #respond input#submit.alt, .woocommerce .wtrContainer  a.button.alt, .woocommerce .wtrContainer  button.button.alt, .woocommerce .wtrContainer  input.button.alt, .woocommerce-page .wtrContainer  #content input.button.alt, .woocommerce-page .wtrContainer  #respond input#submit.alt, .woocommerce-page .wtrContainer  a.button.alt, .woocommerce-page .wtrContainer  button.button.alt, .woocommerce-page .wtrContainer  input.button.alt, .woocommerce .wtrContainer  button.single_add_to_cart_button, /* WooCommerce */ .wtrShtTimeTable .wtrShtTimeTableHeadlinePeriod, .wtrShtTimeTable .wtrShtTimeTableBtn, .wtrTimeTableClassesCategory, .wtrClassDetailsModalClassBtn, .wpcf7 input[type="submit"], .wtrShtPromoEventBtn, .wtrPaginationList li .active, .wtrPaginationList li a:hover, .wtrSmartNavigation .dl-menuwrapper .dl-trigger, .wtrHoverdPostButtonContainer .wtrButtonStd, .wtrCommentList #respond #submit, .wtrPassProtectedContent input[type="submit"], .wtrDefStdButton',
		'css_style' 	=> 'color',
		'transport'		=> 'refresh',
		'css_important'	=> true,
		)
...
$wtr_Color_53 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '#bbpress-forums .bbp-breadcrumb p a, .bbp-pagination-links .page-numbers, #bbpress-forums div.bbp-reply-author a.bbp-author-name, #wtrBbp-topic-tag a, .bbp-login-links a, .wtrBbp-lost-pass .bbp-username, .wtrBbp-lost-pass .bbp-password, .wtrBbp-lost-pass .bbp-remember-me, .wtrBbp-register .bbp-username, .wtrBbp-register .bbp-password, .wtrBbp-register .bbp-remember-me, .wtrBbp-login .bbp-remember-me, .wtrBbp-login .bbp-username, .wtrBbp-login .bbp-password, #bbpress-forums #bbp-single-user-details #bbp-user-navigation a, #bbpress-forums .bbp-topic-freshness a, #bbpress-forums	.bbp-body a.bbp-author-name, #bbpress-forums div.bbp-topic-tags a, #bbpress-forums fieldset.bbp-form select, #new-post input, ul.bbp-forums .bbp-forum-content, .wtrPageContent #bbpress-forums .topic p a, #bbpress-forums .bbp-forums .bbp-forum-freshness a, #bbpress-forums .bbp-forums .bbp-forum-freshness .bbp-topic-meta a.bbp-author-name, #bbpress-forums .bbp-forums .bbp-forum-content a, #bbpress-forums #bbp-single-user-details #bbp-user-navigation a, #bbpress-forums .bbp-topic-freshness a, #bbpress-forums .bbp-body a.bbp-author-name, #bbpress-forums div.bbp-topic-tags a, ul.bbp-forums .bbp-forum-content, .wtrPageContent #bbpress-forums .topic p a, #bbpress-forums .bbp-forums .bbp-forum-freshness a, #bbpress-forums .bbp-forums .bbp-forum-freshness .bbp-topic-meta a.bbp-author-name, #bbpress-forums .bbp-forums .bbp-forum-content a, #bbpress-forums .bbp-breadcrumb p a, .bbp-topic-reply-count, .bbp-topic-voice-count, .bbp-forum-topic-count, .bbp-forum-reply-count, .wtrCommentList .comment-navigation a, .comment-edit-link, p.myaccount_user a, .login .lost_password a, .entry-summary .product_meta .posted_in a, .entry-summary .product_meta .tagged_as a, .woocommerce a.wc-forward, .woocommerce .woocommerce-review-link, .woocommerce .shop_table a, .woocommerce .order_details a, .woocommerce .woocommerce-error a, .woocommerce .woocommerce-info a, .woocommerce .woocommerce-message a, .woocommerce-page .woocommerce-error a, .woocommerce-page .woocommerce-info a, .woocommerce-page .woocommerce-message a, /* WooCommerce */ .wtrEventEntryCategoryItem, .wtrEventEntryCategoryItem a, .wtrClassesTrainerItemLink, .wtrNoItemStreamHeadline, .wtrEventCategoryItem a, .wtrBlogDfPostCategoryItem a, .wtrCommentList #respond .logged-in-as a, .wtrDefBorderLink, .wtrCommentList .trackback .comment-meta a, .wtrCommentList .pingback .comment-meta a, .woocommerce a.chosen-single, .woocommerce-info a',
		'css_style' 	=> 'color',
		'css_important'	=> true,
		)
);
...
$wtr_Color_60 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '.wtrSidebar .bbp-login-form #user_pass, .wtrSidebar .bbp-login-form #user_login, .wtrSidebar #bbp_search, .widget_product_search input[type="search"], .wtrSidebarWdg .widget_product_search input#s, /* WooCommerce */ .wtrSidebarWdg .wtrWidgetNewsletterInput, .wtrSidebarWdg .widget_search input[type="text"]',
		'css_style' 	=> 'background-color',
		)
);
...
$wtr_Color_73 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '.wtrFooter .bbp-login-form #user_pass, .wtrFooter .bbp-login-form #user_login, .wtrFooter #bbp_search, .wtrFooterWdg .widget_product_search input#s, /* WooCommerce */ .wtrFooterWdg .wtrWidgetCountdownHeadlineContainer, .wtrFooterWdg .wtrWidgetNewsletterInput, .wtrFooterWdg .widget_search input[type="text"], .widget_icl_lang_sel_widget #lang_sel a.lang_sel_sel, .widget_icl_lang_sel_widget #lang_sel ul ul li a:hover, .widget_icl_lang_sel_widget #lang_sel ul ul li a',
		'css_style' 	=> 'background-color',
		)
);
...
$wtr_Color_74 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '.wtrFooter .bbp-login-form #user_pass, .wtrFooter .bbp-login-form #user_login, .wtrFooter #bbp_search, .wtrFooterWdg .widget_product_search input#s, /* WooCommerce */ .wtrFooterWdg .wtrWidgetCountdownHeadline a, .wtrFooterWdg .wtrWidgetNewsletterInput, .wtrFooterWdg .widget_search input[type="text"], .widget_icl_lang_sel_widget #lang_sel a',
		'css_style' 	=> 'color',
		)
);
...
$wtr_Color_76 = new WTR_Customize_Setting ( array(
		...
		'control_type'	=> 'color',
		'css_selector' 	=> '.wtrFooter #user-submit:hover, .wtrFooterWdg .widget_price_filter .ui-slider .ui-slider-handle, .wtrFooterWdg .widget_price_filter .ui-slider .ui-slider-range, .wtrFooterWdg .widget_price_filter .price_slider_amount .button:hover, .wtrFooterWdg .price_slider_amount .button:hover, .wtrFooterWdg .widget_shopping_cart .buttons .button:hover, .wtrFooterWdg .widget_shopping_cart .buttons .button.checkout, /* WooCommerce */ .wtrFooterWdg .widget_wtrwidgetpromo .wtrDefStdButton, .wtrFooterWdg .widget_meta ul, .wtrFooterWdg .wtrRotProgress, .wtrFooterWdg .wtrWidgetUpcomingEventsPrice, .wtrFooterWdg .wtrWidgetUpcomingEventsHeadline a, .wtrFooterWdg .wtrWidgetUpcomingEventsRotator .owl-prev:hover, .wtrFooterWdg .wtrWidgetUpcomingEventsRotator .owl-next:hover, .wtrFooterWdg .wtrWidgetUpcomingEventsRotator .owl-dots .owl-dot.active span, .wtrFooterWdg .wtrWidgetCountdownDate, .wtrFooterWdg .wtrWidgetCountdown, .wtrFooterWdg .wtrWidgetNavigationFirstLvlItem:before, .wtrFooterWdg .wtrWidgetRecentCommLink:before, .wtrFooterWdg .wtrWidgetTestimonial .wtrShtTestimonialRot .wtrRotProgress, .wtrFooterWdg .wtrWidgetSocialIconLink:hover, .wtrFooterWdg .wtrWidgetTodayIsOpenHours, .wtrFooterWdg .wtrWidgetOpenIcon, .wtrFooterWdg .wtrWidgetTagItemLink:hover',
		'css_style' 	=> 'background-color',
		'css_important'	=> true,
		)
);
