...
$wtr_TranslateClassesScheduleSHTPdf = new WTR_Text( array(
		'id'			=> 'wtr_TranslateClassesScheduleSHTPdf',
		'class'			=> '',
		'title'			=> __( 'PDF', 'wtr_framework' ),
		'desc' 			=> __( 'Shortcode Classes schedule', 'wtr_framework' ),
		'value'			=> '',
		'default_value' => $wtr_translate[ 'wtr_TranslateClassesScheduleSHTPdf' ],
		'info'			=> '',
		'allow'			=> 'all',
	)
);
...
$wtr_OneClickThemeAlert = new WTR_Alert( array(
		'id'			=> 'wtr_ColorThemeAlert',
		'title'			=> sprintf( __( 'One Click import allows you to fill your site with content based on demo site previously
								...
								<ul class="alertUlImportOneClick">
									...
									<li>All data types added previously by theme: <b>%s</b></li>
								 </ul></br>
								<b>Before starting the one click import it is recommended to backup your Wordpress</b>.', 'wtr_framework' ), WTR_THEME_NAME ),
		'desc'			=> '',
		'value'			=> '',
		'default_value' => '1',
		'info'			=> '',
...
$wtr_TranslateShortcodeSection = new WTR_Section( array(
		...
		'fields'	=> array(
			...
			$wtr_TranslateClassesScheduleSHTPdf,
