	...
	class WTR_Theme_Page extends WTR_Core {
		...
		public function create_options_page(){
			$this->theme_page = add_theme_page(
				sprintf( __( 'Theme Option -  %1$s', 'wtr_framework' ), WTR_THEME_NAME ),
				sprintf( __( 'Theme Option -  %1$s', 'wtr_framework' ), WTR_THEME_NAME ),
				'manage_options',
				'wtr_theme_page',
						...
						<div class="head">
							<div class="logoSec">
								...
								<span class="softVersion">
									 <?php _e( 'ver.', 'wtr_framework' ); echo WTR_THEME_VERSION ?>
								</span>
							</div>
							<div class="headLinks">
								<ul class="moreLinks">
									<li>
										<a href="http://support.wonster.co/" target="_blank" class="WonButton head headBtn support"><?php  _e( 'Support', 'wtr_framework' ) ?></a>
									</li>
									<li>
										<a href="http://support.wonster.co/manual/<?php echo strtolower( WTR_THEME_NAME ); ?>" target="_blank" class="WonButton head headBtn manual"><?php  _e( 'Manual', 'wtr_framework' ) ?></a>
									</li>
									<li>
										<a href="http://wonster.co/get-xml/" target="_blank" class="WonButton head headBtn xml"><?php  _e( 'XML Demo', 'wtr_framework' ) ?></a>
									</li>
									<li>
										<a href="http://themeforest.net/downloads" target="_blank" class="WonButton head headBtn rateUs"><?php  _e( 'Rate Symetrio', 'wtr_framework' ) ?></a>
									</li>
								</ul>
							...
							<div class="content">
								<div class="settings">
									<div class="setNag"><span class="wtr_admin_active_group_title"></span><span class="slash">\</span><span class="underCat wtr_admin_active_section_title"></span>
										<input class="WonButton yellow floatRight wtr_save_form" name="Submit" type="submit" value="<?php  _e( 'Save', 'wtr_framework' ) ?>" />
									</div>
									<div class="ui-form">
									<?php
										// draw modals
									...
									?>
										...
										<div class="footBtns">
											<a  id="go" rel="leanModal" name="wonsterModal" href="#wonsterModalDefault" class="WonButton blue"><?php  _e( 'Default Settings', 'wtr_framework' ) ?></a>
											<!-- <a href="" id="dialog_link" ><?php  _e( 'Default Settings', 'wtr_framework' ) ?></a> -->
											<input class="WonButton yellow floatRight wtr_save_form" name="Submit" type="submit" value="<?php  _e( 'Save', 'wtr_framework' ) ?>" />
											<div class="clear"></div>
										</div>
									<div class="clear"></div>
		...
		private function create_alerts_element_html($message_admin){
			...
			<div class="saveInfo"  style="<?php echo $visablePopup;?>">
				...
				<div class="saveInfoNag saveInfoNagErr wtr_adimin_option_msg  <?php echo 'wtr_admin_set_alert_'.$message_admin; ?>" style="<?php echo $visablePopupImportErr; ?>">
					<div class="infoError"><?php  _e( 'Save error', 'wtr_framework' ) ?></div>
					<div class="btnInfo">
						<a href="" class="WonButton red infoErrorBtn"> <?php  _e( 'Ok, I understand', 'wtr_framework' ) ?></a>
					</div>
				</div>
				...
				<div  style="<?php echo $visablePopupDefault;?>" class="saveInfoNag restoreInfoNagOk <?php echo 'wtr_admin_set_alert_'.$message_admin; ?> wtr_adimin_option_msg">
					<div class="infoOk"><?php  _e( 'Restored default settings', 'wtr_framework' ) ?></div>
				</div>

				<!-- exported data -->
				<div class="saveInfoNag exportInfoNagOk wtr_adimin_option_msg" style="display:none;">
					<div class="infoOk"><?php  _e( 'Exported data', 'wtr_framework' ) ?></div>
				</div>
				...
				<div  style="<?php echo $visablePopupImport;?>" class="saveInfoNag importInfoNagOk <?php echo 'wtr_admin_set_alert_'.$message_admin; ?> wtr_adimin_option_msg">
					<div class="infoOk"><?php  _e( 'Imported settings', 'wtr_framework' ) ?></div>
				</div>
				...
				<div  style="<?php echo $visablePopupImport;?>" class="saveInfoNag importOneClickInfoNagOk <?php echo 'wtr_admin_set_alert_'.$message_admin; ?> wtr_adimin_option_msg">
					<div class="infoOk"><?php  _e( 'Dummy data successfully imported', 'wtr_framework' ) ?></div>
				</div>

				<!-- save success -->
				<div class="saveInfoNag saveInfoNagOk wtr_adimin_option_msg"  style="display:none">
					<div class="infoOk"><?php  _e( 'Save success', 'wtr_framework' ) ?></div>
				</div>
			...
			<!-- MODALS -->
				<!-- modal - default settings  -->
					<div id="wonsterModalDefault" class="wonsterModal">
						<div class="modalNag">
							<span class="modal_tittle"><?php  _e( 'Restore default settings', 'wtr_framework' ) ?></span>
							<a class="modal_close wtr_admin_modal_close" href=""></a>
							<div class="clear"></div>
						</div>
						<div class="modalContent">
							<p><?php  _e( 'Are you sure you want to reset all settings for this theme? <br />All entered data will be lost', 'wtr_framework' ) ?></p>
							<div class="btnModalSpace">
								<a href="" data-trigger="default-settings" class="WonButton red wonster_do_def_serttings"><?php  _e( 'Default Settings', 'wtr_framework' ) ?></a> <a href="" class="AlternativButton wtr_admin_modal_close">No, cancel</a>
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
				...
				<!-- modal - import auto settings  -->
					<div id="wonsterModalRestoreAuto" class="wonsterModal">
						<div class="modalNag">
							<span class="modal_tittle"><?php  _e( 'Restore settings', 'wtr_framework' ) ?></span>
							<a class="modal_close wtr_admin_modal_close" href=""></a>
							<div class="clear"></div>
						</div>
						<div class="modalContent">
							<p><?php  _e( 'Are you sure you want to restore all settings for this theme? <br />All entered data will be lost', 'wtr_framework' ) ?></p>
							<div class="btnModalSpace">
								<a href="" data-trigger="import-auto" class="WonButton red wonster_do_import_auto_serttings"><?php  _e( 'Restore Settings', 'wtr_framework' ) ?></a> <a href="" class="AlternativButton wtr_admin_modal_close">No, cancel</a>
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
				...
				<!-- modal - import text settings  -->
					<div id="wonsterModalRestoreText" class="wonsterModal">
						...
						<div class="modalContent">
							<p><?php  _e( 'Are you sure you want to restore all settings for this theme? <br />All entered data will be lost', 'wtr_framework' ) ?></p>
							<div class="btnModalSpace">
								<a href="" data-trigger="import-text" class="WonButton red wonster_do_import_text_serttings"><?php  _e( 'Import dummy data', 'wtr_framework' ) ?></a> <a href="" class="AlternativButton wtr_admin_modal_close">No, cancel</a>
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
				...
				<!-- modal - one click import  -->
					<div id="wonsterModalRestoreOneCick" class="wonsterModal">
						<div class="modalNag">
							<span class="modal_tittle"><?php  _e( 'Import dummy data', 'wtr_framework' ) ?></span>
							<a class="modal_close wtr_admin_modal_close" href=""></a>
							<div class="clear"></div>
						</div>
						<div class="modalContent">
							<p><?php  _e( 'Are you sure you want to import dummy data? All entered data will be lost.<br /><br /><b>
										   ...
										   Import time depends on server performance and the amount of data needed to be processed.</b>', 'wtr_framework' ) ?></p>
							<div class="btnModalSpace">
								<span class="WonButton red wtr_do_once_click_import"><?php  _e( 'Import data', 'wtr_framework' ) ?></span> <a href="" class="AlternativButton wtr_admin_modal_close">No, cancel</a>
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
				...
				<!-- modal - delete slider -->
					<div id="wonsterModal_sidebarDel" class="wonsterModal">
						<div class="modalNag">
							<span class="modal_tittle"><?php  _e( 'Delete sidebar item', 'wtr_framework' ) ?></span>
							<a class="modal_close wtr_admin_modal_close" href=""></a>
							<div class="clear"></div>
						</div>
						<div class="modalContent">
							<p><?php  _e( 'Are you sure you want to permanently delete sidebar: <b id="sideBarNameDel"></b>', 'wtr_framework' ) ?></p>
							<div class="btnModalSpace">
								<a href="" class="WonButton red wtr_admin_confirm_del_slider"><?php  _e( 'Ok, delete', 'wtr_framework' ) ?></a> <a href="" class="AlternativButton wtr_admin_modal_close"><?php  _e( 'No, cancel', 'wtr_framework' ) ?></a>
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
				...
				<!-- modal - overwrite custom skin  -->
					<div id="wonsterModalOverwriteCustomSkin" class="wonsterModal">
						<div class="modalNag">
							<span class="modal_tittle"><?php  _e( 'Theme custom skin overwrite', 'wtr_framework' ) ?></span>
							<a class="modal_close wtr_admin_modal_close" href=""></a>
							<div class="clear"></div>
						</div>
						<div class="modalContent">
							<p><?php  _e( 'Are you sure you want to overwrite custom style?', 'wtr_framework' ) ?></p>
							<div class="btnModalSpace">
								<span class="WonButton red wtrOverwriteSkin"><?php  _e( 'Yes, overwrite', 'wtr_framework' ) ?></span> <a href="" class="AlternativButton wtr_admin_modal_close">No, cancel</a>
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
