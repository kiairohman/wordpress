				...
				<div class="wfSett">
					...
					if( 'font' == $this->mod ) {
						...
						<div class="setCol-two-three selCol-font-prev-mod">
							...
							<span class="fontPrevNag"> <?php _e( 'Font preview', 'wtr_framework' ) ?></span>
							<div class="clear"></div>
						</div>
						<?php
							...
							<?php
									...
									foreach ( $pages as $page ) { ?>
										<?php $title =  ($page->post_title ) ?  $page->post_title : __( '(no title)', 'wtr_framework' ) ?>
					...
					<?php
							...
							<div class="animationDiv">
								<div class="animationPreview">
									<div class="animatedElement"><?php _e( 'Your animation', 'wtr_framework' ); ?></div>
									<span class="sectionTittle"><?php _e( 'Preview', 'wtr_framework' ); ?></span>
								</div>
							</div>
							<div class="setDescUnder">
							<?php _e( 'Css Animation doesn\'t work on IE 9 and older' , 'wtr_framework' ); ?>
							<div class="clear"></div>
							<div class="WonsterFiled" style="display:none" ><?php echo $this->meta ?></div>
					<?php
						...
						<a rel="leanModal" name="wonsterModal" href="#wonsterModalOverwriteCustomSkin" class="WonButton blue sidebarBtn"><?php  _e( 'Overwrite', 'wtr_framework' ) ?></a>
					<?php
						...
						<a rel="leanModal" name="wonsterModal" href="#wonsterModalRestoreOneCick" class="WonButton red sidebarBtn"><?php  _e( 'Import data', 'wtr_framework' ) ?></a>
					<?php
