	...
	class WTR_Sidebar extends WTR_Filed {
		...
		?>
			<div class="wonsterFiled ">
				...
				<div class="wfSett">
					<input class="<?php echo $this->class ?> sidebarInp wtr_admin_add_sidebar_input" type="text" data-tname="<?php echo $name;?>"  data-id="<?php echo $this->id;?>" data-placeholder="<?php _e( 'Sidebar name', 'wtr_framework' ) ?>" value="">
					<a href="" class="WonButton blue sidebarBtn wtr_admin_add_sidebar"> <?php _e( 'Add sidebar', 'wtr_framework' ) ?> </a>
					<?php if( $this->info ) { ?>
					...
					<div class="sidebarList">
						...
						?>
							<li>
								<div style="display:<?php echo $visUL ?>" class="noSidebar"><?php _e( 'Type sidebar name above and press the button', 'wtr_framework' ) ?></div>
							</li>
						</ul>
					</div>
					<div class="clear"></div>
