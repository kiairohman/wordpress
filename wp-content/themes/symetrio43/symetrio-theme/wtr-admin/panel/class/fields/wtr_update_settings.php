...
if ( ! class_exists( 'WTR_Update_Settings' ) ) {
	...
	class WTR_Update_Settings extends WTR_Filed {
		...
		<div class="wonsterFiled">
				...
				<div class="clear"></div>
				<div class="one-col">
					<h4 class="backupsNag"><?php _e( 'Five last admin data backups:', 'wtr_framework' ) ?></h4>
					...
					<div class="col-one-three ">
						<div class="backupBtns padded">
							<a name="wonsterModal" href="" class="WonButton blue wtr_admin_export_settings"><?php _e( 'Export', 'wtr_framework' ) ?></a>
							<a rel="leanModal" name="wonsterModal" href="#wonsterModalRestoreAuto" class="WonButton red "><?php _e( 'Restore', 'wtr_framework' ) ?></a>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				<div class="wfSettFullWidth">
					<div class="wfDescFullWidth">
					<div class="wfTitle"><?php _e('Export admin data', 'wtr_framework' ) ?></div>
					...
					<div class="wonsterFiled" style="border:0px">
						<div class="wfDesc">
							<div class="wfTitle"><?php _e( 'Select file with import settings (txt file)', 'wtr_framework' ); ?></div>
							<div class="setDescNag"></div>
						</div>
						<div class="wfSett wtrCustomFF">
							<div class="wonsterUpload">
								<div class="setCol-one-three">
									<a href="" class="WonButton blue fileSelect wtr_admin_file_upload" default_size="full" data-editor="" target_type="text" title_modal="none" filter_content="text"><?php _e( 'Select file', 'wtr_framework' ); ?>  </a>
								</div>
								<div class="clear"></div>
							</div>
					...
					<div class="btnImpExpSec">
						<a rel="leanModal" name="wonsterModal" href="#wonsterModalRestoreText" class="WonButton red importBtn" style="margin-top:20px;"><?php _e( 'Import form file', 'wtr_framework' ) ?></a>
						<input id="wtr_export_setting_to_file" type="hidden" name="wtr_export_setting_to_file" value="">
						<input class="WonButton blue blueExportToFile floatRight  wtr_save_form_to_file" name="Submit" type="submit" value="<?php _e( 'Export data to file', 'wtr_framework' ) ?>" />
					</div>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
