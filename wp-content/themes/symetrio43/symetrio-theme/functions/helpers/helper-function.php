...
?>
		...
		<?php printf( __( '<cite class="fn">%s</cite>', 'symetrio' ), get_comment_author_link() ); ?>
		...
		<div class="comment-meta commentmetadata"><span class="comment-date">
			<?php
				...
				printf( __( '%1$s at %2$s', 'symetrio' ), get_comment_date(),  get_comment_time() ); ?>
				</span>
				<?php edit_comment_link( __( '(Edit)', 'symetrio' ), '&nbsp;&nbsp;', '' );
			?>
		</div>
