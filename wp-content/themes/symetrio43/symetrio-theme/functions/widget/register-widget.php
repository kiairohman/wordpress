...
if( ! function_exists( 'wtr_register_sidebars' ) ){
	...
	function wtr_register_sidebars() {
		...
		// footer
		$array_fotter = array(
			__( 'Footer column One', 'wtr_framework' ),
			__( 'Footer column Two', 'wtr_framework' ),
			__( 'Footer column Three', 'wtr_framework' ),
			__( 'Footer column Four', 'wtr_framework' ),
			__( 'Footer column Five', 'wtr_framework' ), // center
		);
