...
if( ! class_exists( 'WTR_Promo_Box_Widget' ) ) {
	...
	class WTR_Promo_Box_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'subtitle' ); ?>"><?php _e( 'Subtitle', 'wtr_framework' ); ?> : </label>
				<input class="widefat" id="<?php echo $this->get_field_id( 'subtitle' ); ?>" name="<?php echo $this->get_field_name( 'subtitle' ); ?>" type="text" value="<?php echo esc_attr( $subtitle ); ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'button_link' ); ?>"><?php _e( 'Button Link', 'wtr_framework' ); ?> : </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'button_label' ); ?>"><?php _e( 'Button Label', 'wtr_framework' ); ?> : </label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_target' ) ); ?>"><?php _e( 'Open Link in new Window', 'wtr_framework' ); ?> : </label>
				<br/>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_target_2' ) ); ?>"><?php _e( 'Yes', 'wtr_framework' ); ?></label>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_target_3' ) ); ?>"><?php _e( 'No', 'wtr_framework' ); ?></label>
			</p>
			<?php
		} // end form
