						...
						<?php if (have_posts()) : ?>
							<ul class="wtrSearchResultsList">
								<?php while ( have_posts() ) : the_post(); ?>
									...
									<?php $post_type	= ( isset( $post_settings[ 'wtr_TranslateSearchFormSearchPostType_' . get_post_type() ] ) ) ? $post_settings[ 'wtr_TranslateSearchFormSearchPostType_' . get_post_type() ] : get_post_type();?>
