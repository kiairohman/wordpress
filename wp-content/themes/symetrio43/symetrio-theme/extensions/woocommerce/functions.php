...
if( ! function_exists( 'wtr_woocommerce_register_sidebars' ) ) {
	...
	function wtr_woocommerce_register_sidebars() {
		...
		// footer
		$woocommerce = array(
			array('name' => __( 'Woocommerce Shop  Page', 'wtr_framework' ), 'id' => 'custom-sidebar-woocommerce_shop'),
			array('name' => __( 'Woocommerce Product Page', 'wtr_framework' ), 'id' => 'custom-sidebar-woocommerce_product'),
			array('name' => __( 'Woocommerce Cart Page', 'wtr_framework' ), 'id' => 'custom-sidebar-woocommerce_cart'),
			array('name' => __( 'Woocommerce Checkout Page', 'wtr_framework' ), 'id' => 'custom-sidebar-woocommerce_checkout'),
			array('name' => __( 'Woocommerce Account Page', 'wtr_framework' ), 'id' => 'custom-sidebar-woocommerce_account')
		);
